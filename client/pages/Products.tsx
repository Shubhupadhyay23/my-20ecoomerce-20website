...
const allProducts = [
  ...
  },
  {
    ...
    price: 39.99,
    image: "https://images.unsplash.com/photo-1523170335684-f006228986c3?w=500&h=500&fit=crop",
    rating: 4.5,
    reviews: 89,
    category: "accessories",
    priceRange: "0-50",
  ...
  },
  {
    ...
    price: 54.99,
    originalPrice: 79.99,
    image: "https://images.unsplash.com/photo-1565182999555-2dd203ef3c0b?w=500&h=500&fit=crop",
    rating: 4,
    reviews: 165,
    category: "accessories",
    priceRange: "50-100",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="hidden lg:block space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                {["0-50", "50-100", "100-300", "300-500", "500-1000"].map((range) => (
